...
const SIMPLE_VALUES: ReadonlyArray<readonly [name: string, path: readonly string[]]> = [
  ...
  ["OMNI_SERVER_ORGANIZATION_NAME", ["server", "organizationName"]],
  ["OMNI_SERVER_CUSTOM_DOMAIN", ["server", "customDomain"]],
...
const SECURITY_PROFILES: readonly SecurityProfile[] = [
  {
    ...
    values: [
      ...
      ["OMNI_SECURITY_CLERK_SCHEME", "scheme"],
  ...
  },
  {
    ...
    values: [
      ...
      ["OMNI_SECURITY_AWS_COGNITO_SCHEME", "scheme"],
  ...
  },
  {
    ...
    values: [
      ...
      ["OMNI_SECURITY_SUPABASE_SCHEME", "scheme"],
