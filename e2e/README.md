...
The application-verification suite is deterministic and ungated. The remaining suites have two
independent gates because they need external infrastructure:
