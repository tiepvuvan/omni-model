...
#
#   1. Proxy E2E          omni-model container -> OpenRouter: chat, streaming,
#                         tool calling, rate limiting (`pnpm test:e2e`)
...
echo "==> [1/3] Proxy E2E — container -> OpenRouter"
echo "         (chat, streaming, tool calling, rate limiting)"
pnpm test:e2e
